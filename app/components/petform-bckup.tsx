...
export default function PetForm() {
  ...
  return (
    <div className="rounded-3xl flex gap-5 flex h-screen">
      {/* LOGIN */}
      <Paper elevation={3} sx={{ 
        ...
        <Typography className='text-center italic' variant='subtitle2'>
          Simulation of the user login to the system.
        </Typography>
      ...
      <Paper elevation={3} sx={{ 
        ...
        <Typography className='text-center italic' variant='subtitle2'>
          Simulation of the user chatting with a pet of their choice in the system and getting a response.
        </Typography>
        <hr className='mt-2 mb-2'/>
      ...
      <Paper elevation={3} sx={{ 
        ...
        <Typography className='text-center italic' variant='subtitle2'>
          Sends an update to the pet status.
        </Typography>
        <hr className='mt-2 mb-2'/>
